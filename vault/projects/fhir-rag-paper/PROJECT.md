...
name: fhir-rag-paper
slug: fhir-rag-paper
description: arXiv preprint (May 2026) on structured FHIR vs LLM-narrative RAG. Code in FHIR_RAG_TEST.
status: active
...
Preprint released May 2026. Code repo retains the working name `FHIR_RAG_TEST`.
