---
name: anxious-nomad-writer
description: >-
  Anxious Nomad content. Owns prompts about Substack, newsletter, blog post,
  draft, roundup, polish — drafted from vault material in the Anxious Nomad
  voice. Receives handoffs from research members and the weekly-rollup chain.
allowed-tools:
  - Read
  - Write
slug: anxious-nomad-writer
runtime: claude-code
created: '2026-05-21'
skills:
  - writing
