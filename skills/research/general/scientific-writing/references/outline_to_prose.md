...
- Exception: only use structured format if the journal explicitly requires it in author guidelines
...
This two-stage process ensures you gather and organize information systematically, create logical structure before writing, produce polished publication-ready prose, and maintain focus on the narrative flow.
